...
public final class GameRule {
	...
	/**
	 * 只有public可调用函数:
	 * isOvercomePrev(List<Card> myCards, List<Card> prevCards)  
	 * 判断针对上家的牌 自家可否出牌
	 */
	...
	public static boolean isOvercomePrev(List<Card> myCards, List<Card> prevCards) {
		...
		CardType prevCardType = getCardType(prevCards);
    ...
    private static CardType getCardType(List<Card> myCards) {
	...
	private static boolean isDan(List<Card> myCards) {
	...
	private static boolean isDuiZi(List<Card> myCards) {
	...
	private static int isSanDaiYi(List<Card> myCards) {
		int flag = -1; // 默认不是3带1
	...
	private static boolean isSanBuDai(List<Card> myCards) {
	...
	private static boolean isShunZi(List<Card> myCards) {
	...
	private static boolean isZhaDan(List<Card> myCards) {
	...
	private static boolean isDuiWang(List<Card> myCards) {
	...
	private static boolean isLianDui(List<Card> myCards) {
	...
	private static boolean isFeiJi(List<Card> myCards) {
		boolean flag = false;
		// 默认不是单
		if (myCards != null) {
	...
	private static boolean isFeiJiBuDai(List<Card> myCards) {
		if (myCards == null) {
			return false;
		}
	...
	private static boolean isFeiJiDai(List<Card> myCards) {
		int size = myCards.size();
	...
	private static boolean isSiDaiEr(List<Card> myCards) {
		boolean flag = false;
